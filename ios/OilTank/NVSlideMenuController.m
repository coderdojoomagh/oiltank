...
- (void)showContentViewControllerAnimated:(BOOL)animated completion:(void(^)(BOOL finished))completion
{
    ...
    //i3 Addition - Conor Breen - 24-01-2013
    //This will force keyboard to resign when you tap into the contentViewController
    if ([self.menuViewController respondsToSelector:@selector(searchBarCancelButtonClicked:)])
        [self.menuViewController performSelector:@selector(searchBarCancelButtonClicked:) withObject:nil];
